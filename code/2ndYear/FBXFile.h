...
public:
	...
	unsigned int	getLightCount() const		{	return (unsigned int)m_lights.size();		}
	unsigned int	getCameraCount() const		{	return (unsigned int)m_cameras.size();	}
	unsigned int	getMaterialCount() const	{	return (unsigned int)m_materials.size();	}
	unsigned int	getSkeletonCount() const	{	return (unsigned int)m_skeletons.size();	}
	unsigned int	getAnimationCount() const	{	return (unsigned int)m_animations.size();	}
