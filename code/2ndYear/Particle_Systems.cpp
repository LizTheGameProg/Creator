...
bool Particle_Systems::onCreate(int a_argc, char* a_argv[]) 
{
	...
	const char* outputs[] = {"colour", "texCoord"};

	m_emitter = new ParticleEmitter();
	//m_emitter->initalise(1000, 500, 
	//		     0.1f, 3.0f, 1, 2, 0.1f, 1.0f,
	//		     glm::vec4(1,1,0,1), glm::vec4(1,0,0,1),
	//			 "../../Build/textures/star_a.tga", "../../Build/shaders/particle.vert", "../../Build/shaders/particle.frag", inputs, outputs);

	return true;
}

void Particle_Systems::onUpdate(float a_deltaTime) 
{
...
void Particle_Systems::onDestroy()
{
